...
| FND-006 | Install and initialize Git | `git --version` succeeds and repository has an approved remote/branch policy | Approved source repository | Blocked |
...
4. Install Git after repository ownership and remote policy are approved.
