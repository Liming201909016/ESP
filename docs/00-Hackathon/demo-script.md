...
Show the automated Evaluation Run and mandatory assertion result. Switch to the secondary Consumer registration and show that it binds to the same Skill Version without copying assets.
