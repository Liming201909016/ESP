...
3. `00-Hackathon/mvp-delivery-profile.md`
4. `00-Hackathon/demo-script.md`
5. `01-Architecture/vision.md`
6. `01-Architecture/business-architecture.md`
7. `01-Architecture/esp-architecture.md`
8. `01-Architecture/technical-architecture.md`
9. `01-Architecture/runtime-architecture.md`
10. `01-Architecture/agent-skill-validation.md`
11. `05-Asset-Standards/logical-skill-contract-standard.md`
12. `05-Asset-Standards/plugin-contract-standard.md`
13. `06-Reference-Models/object-relationship-map.md`
14. `06-Reference-Models/lifecycle-models.md`
15. `06-Reference-Models/dependency-model.md`
16. `02-Data-Design/dataverse-build-workbook.xlsx`
17. `03-Solution-Design/solution-dependency-matrix.md`
18. `03-Solution-Design/copilot-studio-skill-mapping.md`
19. `07-Security-Review-MVP/use-cases.md`
20. `07-Security-Review-MVP/evaluation-test-cases.md`
21. `07-Security-Review-MVP/seed-data-definition.md`
22. `07-Security-Review-MVP/runbook-library-catalog.md`
23. `04-Governance/architecture-baseline-v1.0.md`
24. `08-Development/hackathon-mvp-backlog.md`
25. `08-Development/foundation-backlog.md`
26. `09-Feasibility/technical-feasibility-assessment.md`
27. `09-Feasibility/adr-001-local-mvp-stack.md`
